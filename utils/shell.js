...
export function buildShell(container, { role, user, navItems, activeItem, pageTitle, pageSubtitle, bodyHTML }) {
    const roleLabels = { teacher: 'ครู', parent: 'ผู้ปกครอง', student: 'นักเรียน' };
      ...
      <main class="main-content">
        <header class="page-header">
          ...
          <div class="role-switcher">
            <button class="btn btn-ghost btn-sm role-btn" data-role="teacher">👩‍🏫 ครู</button>
            <button class="btn btn-ghost btn-sm role-btn" data-role="parent">👨‍👦 ผู้ปกครอง</button>
            <button class="btn btn-ghost btn-sm role-btn" data-role="student">🧒 นักเรียน</button>
          </div>
        </header>
